...
public class PauseMenu : MonoBehaviour
{
    ...
    void BuildUI()
    {
        ...
        AddTitle("�����", 0.78f);
        AddButton("����������", 0.55f, Continue, new Color(0.2f, 0.5f, 0.3f));
        AddButton("���������", 0.38f, OpenSettings, new Color(0.25f, 0.4f, 0.6f));
        AddButton("������� ����", 0.21f, GoToMainMenu, new Color(0.5f, 0.2f, 0.2f));
